...
#define APP_ID        "xmrigmulti"
#define APP_NAME      "xmrigMulti"
#define APP_DESC      "xmrigMulti-CC crypto miner (XMRigCC 3.4.0)"
#define APP_VERSION   "1.0.0-cc"
#define APP_DOMAIN    "dreamsweaver.co"
#define APP_SITE      "https://dreamsweaver.co/"
#define APP_COPYRIGHT "Copyright (C) 2023- DreamsWeaver"
